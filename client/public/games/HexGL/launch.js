...
(function() {
  ...
  if (!hasWebGL()) {
    ...
    $('step-1').style.display = 'none';
    $('step-2').style.display = 'none';
    $('step-3').style.display = 'block'; // Mostra solo il loading
    
    // Avvia direttamente il gioco con i controlli da tastiera
    init(0, s[1][3], s[2][3], s[3][3]);
    // 0 = tastiera (KEYBOARD)
    // s[1][3] = qualità (default HIGH)
    // s[2][3] = HUD (default ON)
    // s[3][3] = godmode (default OFF)
  }
